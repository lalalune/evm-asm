...
| `EvmAsm/Codegen/Tests/Cases.lean` | Per-opcode regression test registry: `OpcodeTestCase` struct + `opcodeTestCases` list (**31 cases** as of M10). Wraps each bytecode through the M5b dispatcher for end-to-end ziskemu validation. |
