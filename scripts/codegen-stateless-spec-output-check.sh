...
# Non-empty execution_payload: logs_bloom chunk 1 = 0xBB*32
# (bytes [32..64) of the 256-byte ByteVector; chunk 0 and
# chunks 2..7 stay default zero). Sibling extension to the
