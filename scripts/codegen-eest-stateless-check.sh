...
#                        stock builds budget ~32768 MiB/process; patched lowmem
...
# reaches ~32 GB per process. A "PATCHED-lowmem" build moves the float library
...
if [[ "$ZISKEMU_VERSION" == *PATCHED-lowmem* ]]; then
  ...
  ZISKEMU_AUTO_JOB_MEM_MIB=32768
