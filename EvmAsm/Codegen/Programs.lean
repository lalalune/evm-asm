...
def lookupProgramTail : String → Option BuildUnit
  ...
  | "zisk_account_apply_storage_slot" => some ziskAccountApplyStorageSlotProbeUnit | "zisk_storage_effect_records_probe" => some ziskStorageEffectRecordsProbeUnit
...
def knownProgramNames : List String :=
  ["smoke", "evm_add", "evm_div_v5", "evm_mod_v5",
   ...
   "zisk_account_apply_storage_slot", "zisk_storage_effect_records_probe",
