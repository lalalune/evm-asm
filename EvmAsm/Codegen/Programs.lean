...
def lookupProgramTail : String → Option BuildUnit
  ...
  | "zisk_bal_account_record_array" => some ziskBalAccountRecordArrayProbeUnit | "zisk_tx_gas_sender_bal_lookup" => some ziskTxGasSenderBalLookupProbeUnit | "zisk_tx_gas_bal_post_verify" => some ziskTxGasBalPostVerifyProbeUnit | "zisk_tx_refund_cap" => some ziskTxRefundCapProbeUnit
...
def knownProgramNames : List String :=
  ...
  ["zisk_headers_keccak_chain",
   ...
   "zisk_bal_account_record_array", "zisk_tx_gas_sender_bal_lookup", "zisk_tx_gas_bal_post_verify", "zisk_tx_refund_cap",
