...
def lookupProgramTail : String → Option BuildUnit
  ...
  | "zisk_bal_account_access_outcome_descriptors" => some ziskBalAccountAccessOutcomeDescriptorsProbeUnit
  | "zisk_tx_gas_sender_bal_lookup" => some ziskTxGasSenderBalLookupProbeUnit | "zisk_tx_gas_bal_post_verify" => some ziskTxGasBalPostVerifyProbeUnit
...
def knownProgramNames : List String :=
  ["smoke", "evm_add", "evm_div_v5", "evm_mod_v5",
   ...
   "zisk_runtime_access_seed_initial", "zisk_runtime_access_seed_account_list",
   ...
   "zisk_bal_account_access_outcome_descriptors",
   "zisk_tx_gas_sender_bal_lookup", "zisk_tx_gas_bal_post_verify",
