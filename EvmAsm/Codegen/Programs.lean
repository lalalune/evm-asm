...
def lookupProgramTail : String → Option BuildUnit
  ...
  | "zisk_bal_gas_valid"         => some ziskBalGasValidProbeUnit | "zisk_storage_access_gas" => some ziskStorageAccessGasProbeUnit | "zisk_storage_access_seed" => some ziskStorageAccessSeedProbeUnit
...
def knownProgramNames : List String :=
  ...
  ["zisk_headers_keccak_chain",
   ...
   "zisk_bal_gas_valid", "zisk_storage_access_seed",
