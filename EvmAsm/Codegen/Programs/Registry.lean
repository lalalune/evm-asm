...
def knownProgramNames : List String :=
  ["smoke", "evm_add", "evm_div_v5", "evm_mod_v5",
   ...
   "zisk_bal_account_record_array", "zisk_bal_account_access_outcome_descriptors", "zisk_bal_storage_access_outcome_descriptors", "zisk_tx_gas_sender_bal_lookup", "zisk_tx_gas_bal_post_verify", "zisk_simple_transfer_tx_context", "zisk_simple_transfer_recipient_bal_verify",
