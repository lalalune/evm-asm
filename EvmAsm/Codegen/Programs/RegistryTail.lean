...
def lookupProgramTail : String → Option BuildUnit
  ...
  | "zisk_bal_account_record_array" => some ziskBalAccountRecordArrayProbeUnit | "zisk_tx_gas_sender_bal_lookup" => some ziskTxGasSenderBalLookupProbeUnit | "zisk_tx_gas_bal_post_verify" => some ziskTxGasBalPostVerifyProbeUnit | "zisk_simple_transfer_fee_recipient_bal_verify" => some ziskSimpleTransferFeeRecipientBalVerifyProbeUnit | "zisk_bal_account_access_outcome_descriptors" => some ziskBalAccountAccessOutcomeDescriptorsProbeUnit | "zisk_bal_storage_access_outcome_descriptors" => some ziskBalStorageAccessOutcomeDescriptorsProbeUnit
