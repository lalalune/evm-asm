/-
  ...
  - `popPushZeroHandlers` — BALANCE and EXTCODEHASH
    (BLOBHASH, BLOCKHASH, and EXTCODESIZE have real implementations in Programs/Evm.lean)
...
/-- M18 pop-and-push-zero handlers (BALANCE, EXTCODEHASH).
    ...
    **Known limitations**:
    ...
    - EXTCODEHASH always returns 0 (no external account hash model).
