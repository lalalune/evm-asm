...
/-- Named-post variant of
    `saveRaDivCallDispatchReadyPost_exact_callable_x9out_framed_spec_in_sdivCodeV4`. -/
theorem saveRaDivCallDispatchReadyPost_exact_frame_x9out_framed_spec_in_sdivCodeV4
    {F : EvmAsm.Rv64.Assertion} [EvmAsm.Rv64.Assertion.PCFree F]
    (vRa sp base
      dividendLimb0 dividendLimb1 dividendLimb2 dividendTop
      divisorLimb0 divisorLimb1 divisorLimb2 divisorTop
  ...
  exact saveRaDivCallDispatchReadyPost_exact_callable_x9out_framed_spec_in_sdivCodeV4
...
theorem saveRaDivCallDispatchReadyPost_exact_frame_x9out_divCode_framed_spec_in_sdivCodeV4
    {F : EvmAsm.Rv64.Assertion} [EvmAsm.Rv64.Assertion.PCFree F]
    (vRa sp base
      dividendLimb0 dividendLimb1 dividendLimb2 dividendTop
      divisorLimb0 divisorLimb1 divisorLimb2 divisorTop
    ...
    EvmAsm.Rv64.cpsTripleWithin (EvmAsm.Evm64.unifiedDivBound + 1)
      ...
      (((saveRaDivCallCallablePostNoX9 vRa sp base
        ...
        (.x9 ↦ᵣ x9Out)) ** F)) := by
  rw [EvmAsm.Evm64.divStackDispatchPostCallableExactFrame_unfold] at hStack
  exact saveRaDivCallDispatchReadyPost_exact_callable_x9out_divCode_framed_spec_in_sdivCodeV4
    vRa sp base dividendLimb0 dividendLimb1 dividendLimb2 dividendTop
    divisorLimb0 divisorLimb1 divisorLimb2 divisorTop v2 v5 v6 x9Out
    q0 q1 q2 q3 u0 u1 u2 u3 u4 u5 u6 u7
    shiftMem nMem jMem retMem dMem dloMem scratchUn0 hbase hStack
