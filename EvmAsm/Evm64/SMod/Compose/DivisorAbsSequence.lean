/-
  EvmAsm.Evm64.SMod.Compose.DivisorAbsSequence
...
theorem saveRa_signs_abs_then_divisorAbs_spec_in_smodCodeV4
  ...
  have hPrefix : EvmAsm.Rv64.cpsTripleWithin 27 base (base + divisorAbsOff)
    ...
    simpa [dividendAbsOff, divisorAbsOff, BitVec.add_assoc] using
      (EvmAsm.Rv64.cpsTripleWithin_frameR
        divisorLower
        (by pcFree)
        (saveRa_signs_then_dividendAbs_spec_in_smodCodeV4
  ...
  have hAbs : EvmAsm.Rv64.cpsTripleWithin 21 (base + divisorAbsOff)
      ((base + divisorAbsOff) + 84) (smodCodeV4 base) absPre post := by
