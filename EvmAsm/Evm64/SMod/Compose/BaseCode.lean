...
theorem smodCodeV4_saveRa_sub {base : Word} :
  ...
  exact EvmAsm.Rv64.CodeReq.ofProg_mono_sub base (base + saveRaOff)
    EvmAsm.Evm64.evm_smod_v4 (EvmAsm.Evm64.evm_smod_save_ra_block .x18) 0
    (by simp [saveRaOff])
    (by native_decide)
    (by native_decide)
...
theorem smodCodeV4_preserveDividendSign_sub {base : Word} :
  ...
  exact EvmAsm.Rv64.CodeReq.ofProg_mono_sub base (base + preserveDividendSignOff)
    EvmAsm.Evm64.evm_smod_v4 (EvmAsm.Rv64.ADDI .x13 .x8 0) 3
    (by simp [preserveDividendSignOff])
    (by native_decide)
    (by native_decide)
    (by rw [EvmAsm.Evm64.evm_smod_v4_length]; norm_num)
...
theorem smodCodeV4_savedRaRet_sub {base : Word} :
  ...
  exact EvmAsm.Rv64.CodeReq.ofProg_mono_sub base (base + savedRaRetOff)
    EvmAsm.Evm64.evm_smod_v4 (EvmAsm.Evm64.evm_smod_saved_ra_ret_block .x18) 70
    (by simp [savedRaRetOff])
    (by native_decide)
    (by native_decide)
    (by rw [EvmAsm.Evm64.evm_smod_v4_length]; norm_num)
...
theorem smodCodeV4_modCallable_sub {base : Word} :
  ...
  exact EvmAsm.Rv64.CodeReq.ofProg_mono_sub base (base + wrapperEndOff)
    EvmAsm.Evm64.evm_smod_v4 EvmAsm.Evm64.evm_mod_callable_v4 71
    (by simp [wrapperEndOff])
    (by native_decide)
    (by native_decide)
    (by rw [EvmAsm.Evm64.evm_smod_v4_length]; norm_num)
...
theorem smodCodeV4_top_level_subs {base : Word} :
  ...
  · intro a i h
    unfold smodCodeV4
    exact EvmAsm.Rv64.CodeReq.ofProg_mono_sub base base
      EvmAsm.Evm64.evm_smod_v4 EvmAsm.Evm64.evm_smod_wrapper 0
      (by simp)
      (by unfold EvmAsm.Evm64.evm_smod_v4; simp only [EvmAsm.Rv64.seq, EvmAsm.Rv64.Program]; rfl)
      (by rw [EvmAsm.Evm64.evm_smod_v4_length, EvmAsm.Evm64.evm_smod_wrapper_length]; norm_num)
      (by rw [EvmAsm.Evm64.evm_smod_v4_length]; norm_num)
      a i h
