...
/-- No-NOP/v5 loop body cpsTripleWithin for n=1, max+addback, j=0. -/
theorem divK_loop_body_n1_max_addback_j0_beq_v5_spec_within_noNop
...
/-- No-NOP/v5 loop body cpsTripleWithin for n=1, max+addback, j>0. -/
theorem divK_loop_body_n1_max_addback_jgt0_beq_v5_spec_within_noNop (j : Word)
