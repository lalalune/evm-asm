/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5NoNopComboMTTBorrowCarryMod

  MOD mirror of `FullPathN2V5NoNopComboMTTBorrowCarry`: n=2 max×call×call source path
  over `modCode_noNop_v5` (cp + surgical swaps) — composes the MOD max×call 2-combo
  (#7699) + the MOD j=0 call exit iter borrowCarry (#7703); final-post def + simp
  lemmas code-agnostic (reused from DIV `FullPathN2V5NoNopComboMTT`).  Brick 20 of
...
theorem divK_loop_n2_max_call_call_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
    (sp base : Word)
    ...
    (hcarry2_borrow_0 :
      ...
      BitVec.ult r1.2.2.2.2.1
        (mulsubN4_c3 (divKTrialCallV5QHat r1.2.2.1 r1.2.1 v1) v0 v1 v2 v3 u0Orig0 r1.2.1 r1.2.2.1 r1.2.2.2.1) →
