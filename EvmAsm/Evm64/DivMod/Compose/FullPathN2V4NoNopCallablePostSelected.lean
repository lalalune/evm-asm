/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V4NoNopCallablePostSelected
...
/-- Selected-carry variant of `evm_div_n2_stack_pre_to_unified_post_v4_noNop`.
...
theorem evm_div_n2_stack_pre_to_unified_post_v4_noNop_selectedCarry (sp base : Word)
    (a b : EvmWord)
  ...
  have hA0 := fullDivN2_preloop_loop_unified_exact_x1_scratch_v4_noNop_selectedCarry
