/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5NoNopLoopUnifiedBorrowCarryMod

  MOD mirror of `FullPathN2V5NoNopLoopUnifiedBorrowCarry`: borrow-dispatched
  unified n=2 v5 loop over `modCode_noNop_v5` (cp + surgical swaps).  Takes
  `loopN2SelectedBorrowCarryV5` (the satisfiable-from-shape carry bundle) and
  dispatches the 8 `bltu³` cases to the MOD from_source `_borrowCarry_modCode`
  combos (all 8 now built), extracting the three per-digit borrow-conditional
  carries from the bundle in each arm.  Post defs + carry bundle code-agnostic.
...
theorem divK_loop_n2_unified_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
  ...
  · -- FFF = MMM
    ...
    exact cpsTripleWithin_mono_nSteps (by decide) <| cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        xperm_hyp hp)
      (divK_loop_n2_max_max_max_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
  ...
  · -- FFT = MMC
    ...
    exact cpsTripleWithin_mono_nSteps (by decide) <| cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        simp only [r2MMTN2V5_eq, r1MMTN2V5_eq]
        xperm_hyp hp)
      (divK_loop_n2_max_max_call_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
        sp base jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig1 u0Orig0 q2Old q1Old q0Old raVal
  ...
  · -- FTF = MCM
    ...
    exact cpsTripleWithin_mono_nSteps (by decide) <| cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        xperm_hyp hp)
      (divK_loop_n2_max_call_max_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
        sp base jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig1 u0Orig0 q2Old q1Old q0Old raVal
        retMem dMem dloMem scratchUn0 scratchMem halign hb2 hc2 hb1 hc1 hb0 hc0)
  · -- FTT = MCC
    ...
    exact cpsTripleWithin_mono_nSteps (by decide) <| cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        simp only [r2MTTN2V5_eq, r1MTTN2V5_eq]
        xperm_hyp hp)
      (divK_loop_n2_max_call_call_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
        sp base jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig1 u0Orig0 q2Old q1Old q0Old raVal
        retMem dMem dloMem scratchUn0 scratchMem halign hb2 hc2 hb1 hc1 hb0 hc0)
  · -- TFF = TMM (call-max-max)
    ...
    exact cpsTripleWithin_mono_nSteps (by decide) <| cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        xperm_hyp hp)
      (divK_loop_n2_call_max_max_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
        sp base jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig1 u0Orig0 q2Old q1Old q0Old raVal
        retMem dMem dloMem scratchUn0 scratchMem halign hb2 hc2 hb1 hc1 hb0 hc0)
  · -- TFT = TMT (call-max-call)
    ...
    exact cpsTripleWithin_mono_nSteps (by decide) <| cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        simp only [r2CCCN2V5_eq, r1TMMN2V5_eq]
        xperm_hyp hp)
      (divK_loop_n2_call_max_call_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
        sp base jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig1 u0Orig0 q2Old q1Old q0Old raVal
        retMem dMem dloMem scratchUn0 scratchMem halign hb2 hc2 hb1 hc1 hb0 hc0)
  · -- TTF = CCM (call-call-max)
    ...
    exact cpsTripleWithin_mono_nSteps (by decide) <| cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        xperm_hyp hp)
      (divK_loop_n2_call_call_max_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
        sp base jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig1 u0Orig0 q2Old q1Old q0Old raVal
        retMem dMem dloMem scratchUn0 scratchMem halign hb2 hc2 hb1 hc1 hb0 hc0)
  · -- TTT = CCC (all call)
    ...
    exact cpsTripleWithin_weaken
      ...
      (fun _ hp => by
        ...
        simp only [r2CCCN2V5_eq, r1CCCN2V5_eq]
        xperm_hyp hp)
      (divK_loop_n2_call_call_call_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode
        sp base jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig1 u0Orig0 q2Old q1Old q0Old raVal
        retMem dMem dloMem scratchUn0 scratchMem halign hb2 hc2 hb1 hc1 hb0 hc0)
