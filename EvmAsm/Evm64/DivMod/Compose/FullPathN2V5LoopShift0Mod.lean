/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5LoopShift0Mod

  v5 n=2 shift=0 LOOP body (loopBodyOff → denormOff) over `modCode_noNop_v5`,
  with the carry hypothesis DISCHARGED FROM SHAPE.  The unified loop
  (`divK_loop_n2_unified_from_source_exact_loopIterScratch_v5_noNop_borrowCarry_modCode`,
...
theorem divK_loop_n2_shift0_from_shape_v5_noNop_modCode (sp base : Word)
