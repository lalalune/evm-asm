...
/-- Full n=4 MOD max+skip path over the no-NOP v4 MOD code bundle. -/
theorem evm_mod_n4_full_max_skip_spec_within_v4_noNop (sp base : Word)
  ...
  have hA := evm_mod_n4_preloop_max_skip_spec_within_v4_noNop sp base
...
/-- Full n=4 MOD max+skip path over the full v4 MOD code bundle. -/
theorem evm_mod_n4_full_max_skip_spec_within_v4 (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
    (hb3nz : b3 ≠ 0)
  ...
  exact cpsTripleWithin_modCode_noNop_v4_to_modCode_v4
    (evm_mod_n4_full_max_skip_spec_within_v4_noNop sp base
      a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
      q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
      hbnz hb3nz hshift_nz hbltu hborrow)
