/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5NoNopCallablePostSelected
...
/-- Selected-carry variant of `evm_div_n2_stack_pre_to_unified_post_v5_noNop`.
    This composes the n=2 v4 stack preloop+loop path through denormalization
    without requiring the false universal `Carry2NzAll` package. -/
theorem evm_div_n2_stack_pre_to_unified_post_v5_noNop_selectedCarry (sp base : Word)
    (a b : EvmWord)
  ...
  have hA0 := fullDivN2_preloop_loop_unified_exact_x1_scratch_v5_noNop_selectedCarry
  ...
  have hshift_nz' : fullDivN2Shift (b.getLimbN 1) ≠ 0 := by
    ...
    exact hshift_nz
  have hBNoNop := evm_div_n2_denorm_epilogue_bundled_spec_noNop_v5Final_exact_x1_frame
    bltu_2 bltu_1 bltu_0 sp base
    (a.getLimbN 0) (a.getLimbN 1) (a.getLimbN 2) (a.getLimbN 3)
    (b.getLimbN 0) (b.getLimbN 1) (b.getLimbN 2) (b.getLimbN 3)
