/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5NoNopComboMTMBorrowCarry

  Borrow-dispatched variant of the n=2 max_call_max source path (ComboMTM): each digit's
...
theorem divK_loop_n2_max_call_max_from_source_exact_loopIterScratch_v5_noNop_borrowCarry
    (sp base : Word)
