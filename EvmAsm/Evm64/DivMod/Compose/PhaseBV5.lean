...
private theorem divK_phaseB_init1_code_sub_divCode_noNop_v5 {base : Word} :
...
private theorem divK_phaseB_init2_code_sub_divCode_noNop_v5 {base : Word} :
...
private theorem divK_phaseB_tail_code_sub_divCode_noNop_v5 {base : Word} :
...
private theorem addi_x5_singleton_sub_divCode_noNop_v5 {base : Word} :
...
private theorem bne_x10_singleton_sub_divCode_noNop_v5 {base : Word} :
...
private theorem addi_x5_3_sub_divCode_noNop_v5 {base : Word} :
...
private theorem bne_x7_16_sub_divCode_noNop_v5 {base : Word} :
...
private theorem addi_x5_2_sub_divCode_noNop_v5 {base : Word} :
...
private theorem bne_x6_8_sub_divCode_noNop_v5 {base : Word} :
...
private theorem addi_x5_1_sub_divCode_noNop_v5 {base : Word} :
