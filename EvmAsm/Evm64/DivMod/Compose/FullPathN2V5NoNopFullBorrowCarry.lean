/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5NoNopFullBorrowCarry

  Borrow-dispatched full n=2 v5 preloop+loop composition (entry → denormOff):
  mirror of #7416 (`fullDivN2_preloop_loop_unified_..._selectedCarry`) using the
...
theorem fullDivN2_preloop_loop_unified_exact_x1_scratch_v5_noNop_borrowCarry
  ...
  have hLoop := evm_div_n2_loop_unified_inst_noNop_exact_x1_v5_borrowCarry
