/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5NoNopComboTMMBorrowCarry

  Borrow-dispatched variant of the n=2 call_max_max source path (ComboTMM): each digit's
...
theorem divK_loop_n2_call_max_max_from_source_exact_loopIterScratch_v5_noNop_borrowCarry
    (sp base : Word)
