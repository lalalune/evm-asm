/-
  EvmAsm.Evm64.DivMod.Compose.FullPathN2V5NoNopLoopSelected

  Instantiated selected-carry n=2 v5 loop wrapper: re-exposes the abstract
  `divK_loop_n2_unified_from_source_exact_loopIterScratch_v5_noNop_selectedCarry`
  with the loop-setup register slots named and `u3 = uTop = q*Old = 0` fixed.
  Mirror of `evm_div_n2_loop_unified_inst_noNop_exact_x1_v4_selectedCarry`
  (FullPathN2V4NoNopLoopSelected:295) with the v5 trial accessors + 702 steps.
-/
