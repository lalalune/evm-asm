...
/-- n=4 pre-loop + max+skip loop body over the full `divCode_v4` bundle:
...
theorem evm_div_n4_preloop_max_skip_spec_v4 (sp base : Word)
    ...
    cpsTripleWithin (8 + 21 + 24 + 4 + 21 + 21 + 4 + 76) base (base + denormOff) (divCode_v4 base)
  ...
  exact cpsTripleWithin_divCode_noNop_v4_to_divCode_v4
    (evm_div_n4_preloop_max_skip_spec_v4_noNop sp base
      a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
      q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
      hbnz hb3nz hshift_nz hbltu hborrow)

/-- n=4 pre-loop + call+skip loop body over the full `divCode_v4` bundle. -/
theorem evm_div_n4_preloop_call_skip_spec_v4 (sp base : Word)
  ...
  exact cpsTripleWithin_divCode_noNop_v4_to_divCode_v4
    (evm_div_n4_preloop_call_skip_spec_v4_noNop sp base
      a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
      q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
      retMem dMem dloMem scratchUn0 scratchMem
      hbnz hb3nz hshift_nz halign hbltu hborrow)

/-- Unfold `preloopCallSkipPostN4V4` to the expanded sp-relative form used by
    the full-path composition proof. -/
theorem preloopCallSkipPostN4V4_unfold
    {sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem : Word} :
    preloopCallSkipPostN4V4 sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem =
    ...
    ((.x12 ↦ᵣ sp) ** (.x9 ↦ᵣ signExtend12 4095) **
     ...
     (.x7 ↦ᵣ sp + signExtend12 4088) ** (.x10 ↦ᵣ ms.2.2.2.2) **
     (.x11 ↦ᵣ qHat) ** (.x2 ↦ᵣ ms.2.2.2.1) ** (.x0 ↦ᵣ (0 : Word)) **
  ...
  simp only [loopBodyN4CallSkipJ0PostV4, loopBodyN4SkipPost, loopBodySkipPost,
    loopExitPostN4_j0_eq, se12_32, se12_40, se12_48, se12_56]
  repeat rw [sepConj_assoc']

/-- n=4 pre-loop + call+addback BEQ loop body over the full `divCode_v4` bundle. -/
theorem evm_div_n4_preloop_call_addback_beq_spec_v4 (sp base : Word)
  ...
  exact cpsTripleWithin_divCode_noNop_v4_to_divCode_v4
    (evm_div_n4_preloop_call_addback_beq_spec_v4_noNop sp base
      a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
      q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
      retMem dMem dloMem scratchUn0 scratchMem
      hbnz hb3nz hshift_nz halign hbltu hcarry2_nz hborrow)

/-- Unfold `preloopCallAddbackBeqPostN4V4` to the expanded sp-relative form
    used by the full-path addback composition proof. -/
theorem preloopCallAddbackBeqPostN4V4_unfold
    {sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem : Word} :
    preloopCallAddbackBeqPostN4V4 sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem =
    let shift := (clzResult b3).1
    let antiShift := signExtend12 (0 : BitVec 12) - shift
    let b3' := (b3 <<< (shift.toNat % 64)) ||| (b2 >>> (antiShift.toNat % 64))
    let b2' := (b2 <<< (shift.toNat % 64)) ||| (b1 >>> (antiShift.toNat % 64))
...
/-- Full n=4 max+skip path over the full `divCode_v4` bundle. -/
theorem evm_div_n4_full_max_skip_spec_v4 (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
    (hb3nz : b3 ≠ 0)
  ...
  let ms := mulsubN4 qHat b0' b1' b2' b3' u0 u1 u2 u3
  have hA := evm_div_n4_preloop_max_skip_spec_v4 sp base
    a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
    q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
    hbnz hb3nz hshift_nz hbltu hborrow
  have hB := evm_div_preamble_denorm_epilogue_spec_v4_noNop sp base
    ms.1 ms.2.1 ms.2.2.1 ms.2.2.2.1 shift
    ms.2.2.2.1 (0 : Word) (sp + signExtend12 4056) (sp + signExtend12 4088)
    ms.2.2.2.2 qHat 0 0 0
    b0' b1' b2' b3'
    hshift_nz
  have hBFull := cpsTripleWithin_divCode_noNop_v4_to_divCode_v4 hB
...
/-- Full-path postcondition for the n=4 v4 call+skip branch. -/
@[irreducible]
def fullDivN4CallSkipPostV4
...
/-- Unfold `fullDivN4CallSkipPostV4`, exposing the abstract v4 quotient
    `div128Quot_v4` instead of the executable trial-call helper. -/
theorem fullDivN4CallSkipPostV4_div128Quot_unfold
    {sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem : Word} :
    fullDivN4CallSkipPostV4 sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem =
    let shift := (clzResult b3).1
    let antiShift := signExtend12 (0 : BitVec 12) - shift
    let b3' := (b3 <<< (shift.toNat % 64)) ||| (b2 >>> (antiShift.toNat % 64))
    let b2' := (b2 <<< (shift.toNat % 64)) ||| (b1 >>> (antiShift.toNat % 64))
    ...
    (sp + signExtend12 3936 ↦ₘ scratchOut) **
    regOwn .x1 := by
  delta fullDivN4CallSkipPostV4
  simp only [divKTrialCallV4QHat_eq_div128Quot_v4]

/-- Full n=4 call+skip path over the no-NOP `divCode_noNop_v4` bundle. -/
theorem evm_div_n4_full_call_skip_spec_v4_noNop (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (retMem dMem dloMem scratchUn0 scratchMem : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
    ...
    cpsTripleWithin (8 + 21 + 24 + 4 + 21 + 21 + 4 + 148 + 2 + 23 + 10)
      ...
      (((.x12 ↦ᵣ sp) ** (.x5 ↦ᵣ v5) ** (.x10 ↦ᵣ v10) ** (.x0 ↦ᵣ (0 : Word)) **
       ...
       (sp + signExtend12 3952 ↦ₘ dloMem) ** (sp + signExtend12 3944 ↦ₘ scratchUn0) **
       regOwn .x1) ** (sp + signExtend12 3936 ↦ₘ scratchMem))
      (fullDivN4CallSkipPostV4 sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem) := by
  let shift := (clzResult b3).1
  let antiShift := signExtend12 (0 : BitVec 12) - shift
  let b3' := (b3 <<< (shift.toNat % 64)) ||| (b2 >>> (antiShift.toNat % 64))
  let b2' := (b2 <<< (shift.toNat % 64)) ||| (b1 >>> (antiShift.toNat % 64))
  ...
  let scratchOut := divKTrialCallV4ScratchOut u4 u3 b3' scratchMem
  let ms := mulsubN4 qHat b0' b1' b2' b3' u0 u1 u2 u3
  have hA := evm_div_n4_preloop_call_skip_spec_v4_noNop sp base
    a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
...
/-- Full n=4 call+skip path over the full `divCode_v4` bundle. -/
theorem evm_div_n4_full_call_skip_spec_v4 (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (retMem dMem dloMem scratchUn0 scratchMem : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
  ...
  let scratchOut := divKTrialCallV4ScratchOut u4 u3 b3' scratchMem
  let ms := mulsubN4 qHat b0' b1' b2' b3' u0 u1 u2 u3
  have hA := evm_div_n4_preloop_call_skip_spec_v4 sp base
    a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
    q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
    nMem shiftMem jMem retMem dMem dloMem scratchUn0 scratchMem
    hbnz hb3nz hshift_nz halign hbltu hborrow
...
/-- Full-path postcondition for the n=4 v4 call+addback BEQ branch. -/
@[irreducible]
def fullDivN4CallAddbackBeqPostV4
    (sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem : Word) : Assertion :=
  let shift := (clzResult b3).1
  let antiShift := signExtend12 (0 : BitVec 12) - shift
  let b3' := (b3 <<< (shift.toNat % 64)) ||| (b2 >>> (antiShift.toNat % 64))
  ...
  denormDivPost sp shift un0Out un1Out un2Out un3Out qOut 0 0 0 **
  ((sp + signExtend12 3992) ↦ₘ shift) **
  ((sp + 0) ↦ₘ a0) ** ((sp + 8) ↦ₘ a1) **
  ((sp + 16) ↦ₘ a2) ** ((sp + 24) ↦ₘ a3) **
...
/-- Unfold `fullDivN4CallAddbackBeqPostV4`, exposing the abstract v4 quotient
    `div128Quot_v4` instead of the executable trial-call helper. -/
theorem fullDivN4CallAddbackBeqPostV4_div128Quot_unfold
    {sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem : Word} :
    fullDivN4CallAddbackBeqPostV4 sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem =
    let shift := (clzResult b3).1
    let antiShift := signExtend12 (0 : BitVec 12) - shift
    let b3' := (b3 <<< (shift.toNat % 64)) ||| (b2 >>> (antiShift.toNat % 64))
    let b2' := (b2 <<< (shift.toNat % 64)) ||| (b1 >>> (antiShift.toNat % 64))
  ...
  delta fullDivN4CallAddbackBeqPostV4
  simp only [divKTrialCallV4QHat_eq_div128Quot_v4]

/-- Full n=4 call+addback BEQ path over the full `divCode_v4` bundle. -/
theorem evm_div_n4_full_call_addback_beq_spec_v4 (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (retMem dMem dloMem scratchUn0 scratchMem : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
    ...
    cpsTripleWithin (8 + 21 + 24 + 4 + 21 + 21 + 4 + 224 + 2 + 23 + 10)
      ...
      (((.x12 ↦ᵣ sp) ** (.x5 ↦ᵣ v5) ** (.x10 ↦ᵣ v10) ** (.x0 ↦ᵣ (0 : Word)) **
       ...
       (sp + signExtend12 3952 ↦ₘ dloMem) ** (sp + signExtend12 3944 ↦ₘ scratchUn0) **
       regOwn .x1) ** (sp + signExtend12 3936 ↦ₘ scratchMem))
      (fullDivN4CallAddbackBeqPostV4 sp base a0 a1 a2 a3 b0 b1 b2 b3 scratchMem) := by
  let shift := (clzResult b3).1
  let antiShift := signExtend12 (0 : BitVec 12) - shift
  let b3' := (b3 <<< (shift.toNat % 64)) ||| (b2 >>> (antiShift.toNat % 64))
  let b2' := (b2 <<< (shift.toNat % 64)) ||| (b1 >>> (antiShift.toNat % 64))
  ...
  let un3Out := if carry = 0 then ab'.2.2.2.1 else ab.2.2.2.1
  let u4Out := if carry = 0 then ab'.2.2.2.2 else ab.2.2.2.2
  have hA := evm_div_n4_preloop_call_addback_beq_spec_v4 sp base
    a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
    q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
    nMem shiftMem jMem retMem dMem dloMem scratchUn0 scratchMem
    hbnz hb3nz hshift_nz halign hbltu hcarry2_nz hborrow
...
/-- Full n=4 call+addback BEQ path over the no-NOP `divCode_noNop_v4` bundle. -/
theorem evm_div_n4_full_call_addback_beq_spec_v4_noNop (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (retMem dMem dloMem scratchUn0 scratchMem : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
  ...
  let un3Out := if carry = 0 then ab'.2.2.2.1 else ab.2.2.2.1
  let u4Out := if carry = 0 then ab'.2.2.2.2 else ab.2.2.2.2
  have hA := evm_div_n4_preloop_call_addback_beq_spec_v4_noNop sp base
    a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
    q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
    nMem shiftMem jMem retMem dMem dloMem scratchUn0 scratchMem
    hbnz hb3nz hshift_nz halign hbltu hcarry2_nz hborrow
