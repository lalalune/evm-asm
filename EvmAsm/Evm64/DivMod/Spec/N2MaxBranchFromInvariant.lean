...
/-- N2 j=0 MAX-branch carry-2-nz at the canonical bltu_0 = false, from
    structural normalisation facts and the named c3 invariant.

    Parametrised by `bltu_2, bltu_1 : Bool` since the j=0 input depends on
    the j=1 iteration result `fullDivN2R1V4 bltu_2 bltu_1 a b`. -/
theorem isAddbackCarry2NzN2Max_at_canonical_bltu0_false
