...
/-- N3 j=0 BLT-branch shape-only closure.  Parametrised by `bltu_1 : Bool`
    since the j=0 input depends on `fullDivN3R1V4 bltu_1`. -/
theorem loopBodyN3CallAddbackCarry2NzV4_at_canonical_bltu0_true_of_shape
