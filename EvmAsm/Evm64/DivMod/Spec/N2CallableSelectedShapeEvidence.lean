/-
  EvmAsm.Evm64.DivMod.Spec.N2CallableSelectedShapeEvidence

  Shared selected/reachable evidence bundle for the N2 DIV callable shape route.
-/
...
theorem N2CallableSelectedShapeEvidence.of_parts {a b : EvmWord}
