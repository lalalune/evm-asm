...
/-- Path-callback variant of
    `evm_div_n1_stack_spec_within_word_true_remainders_all_phases_uni`.
    It derives the selected all-true branch facts first, then asks for only the
    evidence reachable on that branch. -/
theorem evm_div_n1_stack_spec_within_word_true_path_remainders_all_phases_uni
    (sp base : Word) (a b : EvmWord)
    (v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
  ...
  exact evm_div_n1_stack_spec_within_word_true_remainders_all_phases_uni
...
/-- Evidence-package variant of
    `evm_div_n1_stack_spec_within_word_true_path_remainders_all_phases_uni`. -/
theorem evm_div_n1_stack_spec_within_word_true_evidence_remainders_all_phases_uni
    (sp base : Word) (a b : EvmWord)
    (v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
    ...
    cpsTripleWithin unifiedDivBound base (base + nopOff) (divCode base)
      (divModStackDispatchPre sp a b
        ...
        shiftMem nMem jMem retMem dMem dloMem scratch_un0)
      (divStackDispatchPost sp a b) := by
  exact evm_div_n1_stack_spec_within_word_true_path_remainders_all_phases_uni
    sp base a b v5 v6 v7 v10 v11Old q0 q1 q2 q3 u0Old u1Old u2Old
    u3Old u4Old u5 u6 u7 nMem shiftMem jMem retMem dMem dloMem
    scratch_un0 hbnz hb3z hb2z hb1z hshift_nz halign hr3_lt hr2_lt hr1_lt
    (N1AllTruePathEvidence.toCallback hpathFacts)

/-- All-phases overestimate-path variant of
    `evm_div_n1_stack_spec_within_word_true_evidence_remainders_all_phases_uni`.
    This derives the selected all-true evidence package internally before
    invoking the evidence-based stack wrapper. -/
theorem evm_div_n1_stack_spec_within_word_true_all_phases_overestimate_path_uni
    (sp base : Word) (a b : EvmWord)
    (v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
  ...
  exact evm_div_n1_stack_spec_within_word_true_evidence_remainders_all_phases_uni
    sp base a b v5 v6 v7 v10 v11Old q0 q1 q2 q3 u0Old u1Old u2Old
    u3Old u4Old u5 u6 u7 nMem shiftMem jMem retMem dMem dloMem
    scratch_un0 hbnz hb3z hb2z hb1z hshift_nz halign
    hr3_lt hr2_lt hr1_lt hpathFacts

/-- Conjunct-level variant of the full-code all-call n=1 stack wrapper. -/
theorem evm_div_n1_stack_spec_within_word_true_r3_conjunct_overestimate_path_uni
    (sp base : Word) (a b : EvmWord)
    (v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
    ...
    cpsTripleWithin unifiedDivBound base (base + nopOff) (divCode base)
      ...
      (divStackDispatchPost sp a b) := by
  exact
    evm_div_n1_stack_spec_within_word_true_all_phases_overestimate_path_uni
