...
/-- Trial-bundled n=1 exact-x1 DIV wrapper from normalized mulsub plus
    normalized final-remainder obligations. -/
theorem evm_div_n1_stack_spec_within_word_exact_x1_trial_normalized_remainder_uni
    (sp base : Word) (a b : EvmWord)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
...
/-- Shape-specialized n=1 exact-x1 DIV wrapper from normalized mulsub plus
    normalized final-remainder obligations. -/
theorem evm_div_n1_stack_spec_within_word_exact_x1_shape_normalized_remainder_uni
    (sp base : Word) (a b : EvmWord)
    (v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
  ...
  have htrial : N1TrialWitnesses a b :=
    n1TrialWitnesses_of_getLimbN_shape_shift_nz
      a b hbnzGet hb3z hb2z hb1z hshift_nz
  exact evm_div_n1_stack_spec_within_word_exact_x1_trial_normalized_remainder_uni
    sp base a b
    (a.getLimbN 0) (a.getLimbN 1) (a.getLimbN 2) (a.getLimbN 3)
    (b.getLimbN 0) (b.getLimbN 1) (b.getLimbN 2) (b.getLimbN 3)
    v5 v6 v7 v10 v11Old
...
/-- Trial-bundled n=1 no-NOP DIV wrapper from normalized mulsub plus
    normalized final-remainder obligations. -/
theorem evm_div_n1_stack_spec_within_word_noNop_trial_normalized_remainder_uni
    (sp base : Word) (a b : EvmWord)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
...
/-- Shape-specialized n=1 no-NOP DIV wrapper from normalized mulsub plus
    normalized final-remainder obligations. -/
theorem evm_div_n1_stack_spec_within_word_noNop_shape_normalized_remainder_uni
    (sp base : Word) (a b : EvmWord)
    (v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratch_un0 : Word)
  ...
  have htrial : N1TrialWitnesses a b :=
    n1TrialWitnesses_of_getLimbN_shape_shift_nz
      a b hbnzGet hb3z hb2z hb1z hshift_nz
  exact evm_div_n1_stack_spec_within_word_noNop_trial_normalized_remainder_uni
    sp base a b
    (a.getLimbN 0) (a.getLimbN 1) (a.getLimbN 2) (a.getLimbN 3)
    (b.getLimbN 0) (b.getLimbN 1) (b.getLimbN 2) (b.getLimbN 3)
    v5 v6 v7 v10 v11Old
