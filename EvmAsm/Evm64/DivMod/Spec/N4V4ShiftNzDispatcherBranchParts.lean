/-
  EvmAsm.Evm64.DivMod.Spec.N4V4ShiftNzDispatcherBranchParts
...
theorem evm_div_n4_shift_nz_stack_spec_of_branch_skip_parts
    (sp base : Word)
...
/-- Final named no-NOP n=4, shift-nonzero DIV dispatcher surface from direct
    skip-branch runtime evidence. -/
theorem evm_div_n4_shift_nz_stack_spec_noNop_of_branch_skip_parts
    (sp base : Word)
    (a b : EvmWord) (v5 v6 v7 v10 v11 : Word)
    (q0 q1 q2 q3 u0 u1 u2 u3 u4 u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratchUn0 scratchMem : Word)
...
theorem evm_div_n4_shift_nz_stack_spec_of_branch_addback_bounds_parts
    (sp base : Word)
    (a b : EvmWord) (v5 v6 v7 v10 v11 : Word)
    (q0 q1 q2 q3 u0 u1 u2 u3 u4 u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratchUn0 scratchMem : Word)
...
/-- Final named no-NOP n=4, shift-nonzero DIV dispatcher surface from direct
    addback-branch runtime-bounds evidence. -/
theorem evm_div_n4_shift_nz_stack_spec_noNop_of_branch_addback_bounds_parts
    (sp base : Word)
    (a b : EvmWord) (v5 v6 v7 v10 v11 : Word)
    (q0 q1 q2 q3 u0 u1 u2 u3 u4 u5 u6 u7
     nMem shiftMem jMem retMem dMem dloMem scratchUn0 scratchMem : Word)
