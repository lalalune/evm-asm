...
/-- Full-v4 N1 call/max/max/max exact-frame stack spec consuming all-true N1
    path evidence for canonical `getLimbN` inputs. -/
theorem evm_div_n1_call_maxmaxmax_stack_spec_within_word_v4_preNoX1_callableExtra_x9In_exactFrame_unified_of_path_evidence_getLimbN
    (sp base : Word) (a b : EvmWord)
  ...
  exact evm_div_n1_call_maxmaxmax_stack_spec_within_word_v4_preNoX1_callableExtra_x9In_exactFrame_unified_of_selected_if_borrow_input_hdivs
    ...
    hbnz hb3z hb2z hb1z hshift_nz halign hselected hdivs
