/-
  ...
  premise through the N2 stack path. That package is counterexample-false as a
  final/public proof surface, so this module is retained as a compatibility
  shim only. New v4 N2 callable/final work should use selected-carry wrappers
  from `Spec.N2V4CallableExactSelected` instead of extending this path.
-/
...
theorem evm_div_n2_stack_spec_within_word_exact_x1_noNop_of_mulsub_overestimate
    ...
    cpsTripleWithin 946 base (base + nopOff) (divCode_noNop base)
      ...
      (divStackDispatchPostNoX1 sp a b **
        (.x9 ↦ᵣ (signExtend12 4095 : Word))) := by
  simpa [unifiedDivBound] using
    evm_div_n2_stack_spec_within_word_exact_x1_noNop_uni
      bltu_2 bltu_1 bltu_0 sp base a b
      a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
      q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7
      nMem shiftMem jMem retMem dMem dloMem scratch_un0
