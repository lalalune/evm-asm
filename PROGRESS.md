...
> Snapshot: `2026-06-05` @ [`f9bd3a801`](https://github.com/Verified-zkEVM/evm-asm/commit/f9bd3a801f9be7e1930838b40ec95e323baf47d3)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **517**
- ziskemu round-trip scripts: **539** under `scripts/codegen-*.sh`
