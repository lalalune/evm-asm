...
> Snapshot: `2026-05-20` @ [`423670836`](https://github.com/Verified-zkEVM/evm-asm/commit/423670836c7383b052a15f7e5aac907a86eafdee)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **21**
- ziskemu round-trip scripts: **20** under `scripts/codegen-*.sh`
