...
> Snapshot: `2026-05-21` @ [`8b448f469`](https://github.com/Verified-zkEVM/evm-asm/commit/8b448f469155a1ee352969e17739d8ab5a3dd4ee)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **52**
- ziskemu round-trip scripts: **47** under `scripts/codegen-*.sh`
