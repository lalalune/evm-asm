...
> Snapshot: `2026-05-21` @ [`586e11124`](https://github.com/Verified-zkEVM/evm-asm/commit/586e11124ca4110a27402d2f7bad970743587dc9)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **54**
- ziskemu round-trip scripts: **49** under `scripts/codegen-*.sh`
