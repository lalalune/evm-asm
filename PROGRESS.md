...
> Snapshot: `2026-06-06` @ [`8bac7afbf`](https://github.com/Verified-zkEVM/evm-asm/commit/8bac7afbfe995bcfe3f9da5d69669db8b0747e8d)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **831**
- ziskemu round-trip scripts: **587** under `scripts/codegen-*.sh`
