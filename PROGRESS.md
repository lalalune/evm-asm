...
> Snapshot: `2026-06-06` @ [`8e9e51012`](https://github.com/Verified-zkEVM/evm-asm/commit/8e9e5101287e9b1db4c2d9272bc6c72fd0fa13cd)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **839**
- ziskemu round-trip scripts: **598** under `scripts/codegen-*.sh`
