...
> Snapshot: `2026-05-27` @ [`d4b038d0f`](https://github.com/Verified-zkEVM/evm-asm/commit/d4b038d0f1a628ec2f4247a26f4c4c7851ae5452)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **315**
- ziskemu round-trip scripts: **306** under `scripts/codegen-*.sh`
