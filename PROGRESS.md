...
> Snapshot: `2026-05-31` @ [`c65a044ec`](https://github.com/Verified-zkEVM/evm-asm/commit/c65a044ecfdb60b994fcf829bccf151dcabbc1f6)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **461**
- ziskemu round-trip scripts: **453** under `scripts/codegen-*.sh`
