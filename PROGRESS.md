...
> Snapshot: `2026-06-06` @ [`0773299a1`](https://github.com/Verified-zkEVM/evm-asm/commit/0773299a13f55771610c8eec6929792335647dfd)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **538**
- ziskemu round-trip scripts: **579** under `scripts/codegen-*.sh`
