...
> Snapshot: `2026-05-20` @ [`5676175af`](https://github.com/Verified-zkEVM/evm-asm/commit/5676175afc63a1be9f234a1533382547aa32a73f)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **15**
- ziskemu round-trip scripts: **13** under `scripts/codegen-*.sh`
