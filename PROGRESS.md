...
> Snapshot: `2026-05-21` @ [`793545750`](https://github.com/Verified-zkEVM/evm-asm/commit/7935457504edafbbabc5d71f032e89a600e2f316)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **55**
- ziskemu round-trip scripts: **50** under `scripts/codegen-*.sh`
