...
> Snapshot: `2026-06-02` @ [`230c4cd6f`](https://github.com/Verified-zkEVM/evm-asm/commit/230c4cd6f1299fe37fad1861f8cba499a8da5de3)
...
- ziskemu round-trip scripts: **502** under `scripts/codegen-*.sh`
