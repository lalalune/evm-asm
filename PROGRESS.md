...
> Snapshot: `2026-06-03` @ [`8a7bbae99`](https://github.com/Verified-zkEVM/evm-asm/commit/8a7bbae9991788774603137a064719dcf9e96993)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **503**
- ziskemu round-trip scripts: **510** under `scripts/codegen-*.sh`
