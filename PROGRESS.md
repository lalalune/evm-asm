...
> Snapshot: `2026-05-21` @ [`59de76d3b`](https://github.com/Verified-zkEVM/evm-asm/commit/59de76d3b17b75a7d4a818c357671005a66e3ed1)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **53**
- ziskemu round-trip scripts: **48** under `scripts/codegen-*.sh`
