...
> Snapshot: `2026-05-26` @ [`e21454630`](https://github.com/Verified-zkEVM/evm-asm/commit/e2145463066ee47c82de0aad7e5306859fe119ab)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **310**
- ziskemu round-trip scripts: **300** under `scripts/codegen-*.sh`
