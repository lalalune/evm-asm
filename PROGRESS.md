...
> Snapshot: `2026-06-05` @ [`ed077f408`](https://github.com/Verified-zkEVM/evm-asm/commit/ed077f408b5c55e7aad53d3534053774179a43db)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **516**
- ziskemu round-trip scripts: **538** under `scripts/codegen-*.sh`
