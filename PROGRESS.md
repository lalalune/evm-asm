...
> Snapshot: `2026-06-04` @ [`20c271258`](https://github.com/Verified-zkEVM/evm-asm/commit/20c2712588ae9ceff1f47f9084da690080293ef4)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **508**
- ziskemu round-trip scripts: **524** under `scripts/codegen-*.sh`
