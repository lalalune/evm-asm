...
> Snapshot: `2026-05-31` @ [`f16878554`](https://github.com/Verified-zkEVM/evm-asm/commit/f16878554276296374066ae34f753722ecaa55e1)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **465**
- ziskemu round-trip scripts: **457** under `scripts/codegen-*.sh`
