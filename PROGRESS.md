...
> Snapshot: `2026-05-20` @ [`2bcca184f`](https://github.com/Verified-zkEVM/evm-asm/commit/2bcca184f7e703aa9f320218519c60997629ca09)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **24**
- ziskemu round-trip scripts: **23** under `scripts/codegen-*.sh`
