...
> Snapshot: `2026-05-21` @ [`ab27845ce`](https://github.com/Verified-zkEVM/evm-asm/commit/ab27845ceb910a4832a3d321c383721f8e907415)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **56**
- ziskemu round-trip scripts: **51** under `scripts/codegen-*.sh`
