...
> Snapshot: `2026-06-05` @ [`270f8b2ce`](https://github.com/Verified-zkEVM/evm-asm/commit/270f8b2ce7641071e91c2663537acdfd282c7f93)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **519**
- ziskemu round-trip scripts: **547** under `scripts/codegen-*.sh`
