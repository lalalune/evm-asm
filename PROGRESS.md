...
> Snapshot: `2026-05-19` @ [`9726d2161`](https://github.com/Verified-zkEVM/evm-asm/commit/9726d21612f751d5e28bb9535841e3600f12de12)
...
| ✅ DIV | proven | `evm_div_stack_spec` | N=946 unified (n=1..4 × shift0/nz × skip/addback) |
| 🟡 SDIV | partial | `evm_sdiv_exact_callable_return_stack_spec_within` | callable+dispatch shim; no top-level evm_sdiv_stack_spec yet |
| ✅ MOD | proven | `evm_mod_stack_spec` | N=946 unified |
