...
> Snapshot: `2026-05-22` @ [`1034165db`](https://github.com/Verified-zkEVM/evm-asm/commit/1034165db9bdc62e4e5c03c83af1b22d40372948)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **133**
- ziskemu round-trip scripts: **126** under `scripts/codegen-*.sh`
