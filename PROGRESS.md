...
> Snapshot: `2026-05-31` @ [`6fa5ab9cd`](https://github.com/Verified-zkEVM/evm-asm/commit/6fa5ab9cd6512a6a6888fc5fe4fd16f92ecadfd1)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **470**
- ziskemu round-trip scripts: **461** under `scripts/codegen-*.sh`
