...
> Snapshot: `2026-05-20` @ [`01d581959`](https://github.com/Verified-zkEVM/evm-asm/commit/01d581959c9f726f5af89e163cbfc57586818021)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **29**
- ziskemu round-trip scripts: **24** under `scripts/codegen-*.sh`
