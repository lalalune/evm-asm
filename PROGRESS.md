...
> Snapshot: `2026-06-03` @ [`a60809c9e`](https://github.com/Verified-zkEVM/evm-asm/commit/a60809c9e00f7d1bf49db242cf3a9f2a699b1313)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **499**
- ziskemu round-trip scripts: **505** under `scripts/codegen-*.sh`
