...
> Snapshot: `2026-06-06` @ [`abcbe2d71`](https://github.com/Verified-zkEVM/evm-asm/commit/abcbe2d71395b02cd751faddc94733a0e4d89268)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **1043**
- ziskemu round-trip scripts: **586** under `scripts/codegen-*.sh`
