...
> Snapshot: `2026-06-03` @ [`369a9eda4`](https://github.com/Verified-zkEVM/evm-asm/commit/369a9eda4addf350e6597d8b0a36325c50a4784a)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **500**
- ziskemu round-trip scripts: **506** under `scripts/codegen-*.sh`
