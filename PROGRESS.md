...
> Snapshot: `2026-05-21` @ [`459156f10`](https://github.com/Verified-zkEVM/evm-asm/commit/459156f101575f6c6674bf658292b46427c305e7)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **80**
- ziskemu round-trip scripts: **73** under `scripts/codegen-*.sh`
