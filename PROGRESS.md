...
> Snapshot: `2026-05-21` @ [`0f7c40274`](https://github.com/Verified-zkEVM/evm-asm/commit/0f7c402749cfe6d2a4c2813dd4979a2be6a592ab)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **47**
- ziskemu round-trip scripts: **42** under `scripts/codegen-*.sh`
