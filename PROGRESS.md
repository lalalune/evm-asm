...
> Snapshot: `2026-05-21` @ [`fb1480116`](https://github.com/Verified-zkEVM/evm-asm/commit/fb14801162da83be9d504b32b11594ede8542f27)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **62**
- ziskemu round-trip scripts: **55** under `scripts/codegen-*.sh`
