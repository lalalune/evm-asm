...
> Snapshot: `2026-05-28` @ [`910642eea`](https://github.com/Verified-zkEVM/evm-asm/commit/910642eea221b0e2e3f47a19d29cadf1c05de298)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **316**
- ziskemu round-trip scripts: **307** under `scripts/codegen-*.sh`
